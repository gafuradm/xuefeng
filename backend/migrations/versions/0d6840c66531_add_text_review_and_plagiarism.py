"""add_text_review_and_plagiarism

Revision ID: 0d6840c66531
Revises: 693d640c1486
Create Date: 2026-05-31 00:58:10.028640
...
revision: str = '0d6840c66531'
down_revision: Union[str, None] = '693d640c1486'
...
def downgrade() -> None:
    ...
    sa.UniqueConstraint('invite_code', name=op.f('schools_invite_code_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    ...
    sa.UniqueConstraint('user_id', name=op.f('user_auth_user_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    ...
    sa.UniqueConstraint('lesson_id', name=op.f('lesson_videos_lesson_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
