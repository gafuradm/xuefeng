...
ROLE_MODULE_ACCESS = {
    'schoolchild': ['learning', 'tests', 'schools_student', 'video', 'pdf_chat', 'exam_tickets', 'essay_check', 'planner', 'ocr', 'video_generation', 'soft_skills', 'aidouble', 'rating_view', 'admission'],
    'applicant': ['learning', 'tests', 'video', 'pdf_chat', 'exam_tickets', 'essay_check', 'planner', 'ocr', 'video_generation', 'aidouble', 'rating_view', 'admission'],
    'student': ['learning', 'tests', 'courses_create', 'schools_student', 'video', 'pdf_chat', 'exam_tickets', 'essay_check', 'planner', 'scientific', 'data_analysis', 'ocr', 'video_generation', 'supervisor_search', 'internship_match', 'soft_skills', 'aidouble', 'rating_view', 'admission'],
    'master': ['learning', 'tests', 'courses_create', 'scientific', 'data_analysis', 'hypothesis_generator', 'supervisor_search', 'soft_skills', 'planner', 'internship_match', 'aidouble', 'rating_view'],
    'phd': ['learning', 'tests', 'courses_create', 'scientific', 'data_analysis', 'hypothesis_generator', 'supervisor_search', 'peer_review', 'soft_skills', 'planner', 'internship_match', 'aidouble', 'rating_view'],
    ...
    'job_seeker': ['soft_skills', 'internship_match', 'planner', 'essay_check_resume', 'aidouble', 'rating_view'],
